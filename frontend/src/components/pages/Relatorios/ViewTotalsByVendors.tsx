...
import totalsByVendors from './reportInternals/totalsByVendors'

export default function ViewTotalsByVendors() {
    ...
    return <>
        ...
        <SideBar />
        <Content>
            <h2 className="p-4">Relatório - Totais por Fornecedor</h2>
            <div className="p-4 flex justify-center items-center gap-4">
                ...
                <Button className="hover:bg-green-100 mx-2"
                    onClick={() => totalsByVendors(date1, date2, status)}>
                    <i>&#xe926;</i> Pronto
                </Button>
            </div>
        </Content>
